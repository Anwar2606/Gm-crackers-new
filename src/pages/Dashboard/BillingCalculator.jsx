...
import MyLogo from '../assets/logo no back.png';
...
doc.setFontSize(8);
 doc.text('Phone no:9843390105/6383852337', 150, headerStartY + 5 + 4 * lineSpacing);
doc.setFont('helvetica', 'bold');
...
doc.text(`Date: ${formattedDate}`, 150, headerStartY + 5 + 3 * lineSpacing);
doc.setFontSize(8);
 doc.text('Phone no : 98433 90105/63838 52337', 150, headerStartY + 5 + 4 * lineSpacing);
doc.setFont('helvetica', 'bold');
