...
// ✅ COPY TYPE
doc.text(`${copyType} COPY`, 150, headerStartY + 5 + lineSpacing);

// ✅ INVOICE NUMBER
const formattedInvoiceNumber = String(detail.invoiceNumber).padStart(3, '0');
...
// ✅ Header Border
const headerEndY = headerStartY + 13 + 4 * lineSpacing; // removed +6 (no extra space)
doc.setDrawColor(0, 0, 0);
doc.setLineWidth(0.2);
...
const customerAccountTable = [
  ['TO', '', 'Account Details', ''],
  ['Name', clean(customerName), 'A/c Holder Name', 'P.Manikandan'],
  ['Address', clean(customerAddress), 'A/c Number', '24830200002055'],
  ['State', clean(customerState), 'Bank Name', 'FEDERAL BANK'],
  ['Phone', clean(customerPhoneNo), 'Branch', 'SIVAKASI'],
  ['GSTIN', clean(customerGSTIN), 'IFSC Code', 'FDRL0002483'],
  ['PAN', clean(customerPan), '', '']
];

doc.autoTable({
  body: customerAccountTable,
  startY: headerEndY, // ✅ starts right after header
  theme: 'grid',
